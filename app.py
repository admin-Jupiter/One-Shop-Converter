...
def rotate_pdf_1():
    if request.method == 'POST':  
        ...
        pagenum = int(request.form['typeNumber'])
...
@app.route('/ppt_pdf/')
def ppt_pdf():
    return render_template('pptpdf.html')
...
@app.route('/ppt_img/')
def ppt_img():
    return render_template('pptimg.html')
...
def compress_pdf_1():
    if request.method == 'POST':
        ...
        if compressed_quality == 'option1':
            subprocess.call(["C:/Users/Admin/anaconda3/envs/CSY/Library/bin/gs.exe", '-sDEVICE=pdfwrite', '-dCompatibilityLevel=1.4', '-dPDFSETTINGS={}'.format(quality[1]),'-dNOPAUSE', '-dQUIET', '-dBATCH', '-sOutputFile={}'.format(output_file_path), input_file_path])
        
        elif compressed_quality == 'option2':
            subprocess.call(["C:/Users/Admin/anaconda3/envs/CSY/Library/bin/gs.exe", '-sDEVICE=pdfwrite', '-dCompatibilityLevel=1.4', '-dPDFSETTINGS={}'.format(quality[2]),'-dNOPAUSE', '-dQUIET', '-dBATCH', '-sOutputFile={}'.format(output_file_path), input_file_path])

        elif compressed_quality == 'option3':
            subprocess.call(["C:/Users/Admin/anaconda3/envs/CSY/Library/bin/gs.exe", '-sDEVICE=pdfwrite', '-dCompatibilityLevel=1.4', '-dPDFSETTINGS={}'.format(quality[3]),'-dNOPAUSE', '-dQUIET', '-dBATCH', '-sOutputFile={}'.format(output_file_path), input_file_path])

        elif compressed_quality == 'option4':
            subprocess.call(["C:/Users/Admin/anaconda3/envs/CSY/Library/bin/gs.exe", '-sDEVICE=pdfwrite', '-dCompatibilityLevel=1.4', '-dPDFSETTINGS={}'.format(quality[4]),'-dNOPAUSE', '-dQUIET', '-dBATCH', '-sOutputFile={}'.format(output_file_path), input_file_path])

        elif compressed_quality == 'option0':
            subprocess.call(["C:/Users/Admin/anaconda3/envs/CSY/Library/bin/gs.exe", '-sDEVICE=pdfwrite', '-dCompatibilityLevel=1.4', '-dPDFSETTINGS={}'.format(quality[0]),'-dNOPAUSE', '-dQUIET', '-dBATCH', '-sOutputFile={}'.format(output_file_path), input_file_path])
...
@app.route('/wav_text/')
def wav_text():
    return render_template('wav_text.html')
