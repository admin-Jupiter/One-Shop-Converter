...
__all__ = [ 'FONTSTRIKETHROUGH', 'Font', 'Checked', 'Gray', 'StdFont',
           'OLE_XSIZE_HIMETRIC', 'FontEvents', 'Monochrome',
           'IPictureDisp', 'OLE_CANCELBOOL', 'FONTITALIC',
           'IFontDisp', 'VgaColor', 'IFontEventsDisp', 'Default',
           'OLE_TRISTATE', 'Color', 'OLE_YPOS_PIXELS', 'FONTBOLD',
           'LoadPictureConstants', 'FONTUNDERSCORE', 'IFont',
           'Unchecked', 'OLE_YSIZE_HIMETRIC', 'Picture',
           'OLE_XPOS_PIXELS', 'StdPicture', 'OLE_YSIZE_PIXELS',
           'OLE_YPOS_HIMETRIC', 'OLE_XPOS_HIMETRIC',
           'OLE_YPOS_CONTAINER', 'OLE_HANDLE', 'FONTSIZE', 'FONTNAME',
           'OLE_XSIZE_PIXELS', 'OLE_ENABLEDEFAULTBOOL',
           'OLE_OPTEXCLUSIVE', 'IPicture', 'OLE_XSIZE_CONTAINER',
           'OLE_YSIZE_CONTAINER', 'OLE_COLOR', 'OLE_XPOS_CONTAINER']
