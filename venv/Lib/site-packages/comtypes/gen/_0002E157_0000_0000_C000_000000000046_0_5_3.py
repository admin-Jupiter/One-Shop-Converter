# -*- coding: mbcs -*-
typelib_path = 'C:\\Users\\Admin\\AppData\\Local\\Kingsoft\\WPS Office\\11.2.0.11191\\office6\\vbe6ext.olb'
...
__all__ = [ '_Components', 'vbext_ct_Document', 'References',
           'vbext_pp_none', 'vbext_ws_Maximize', 'SelectedComponents',
           'vbext_wt_ProjectWindow', 'Components', 'vbext_pk_Get',
           'vbext_wt_PropertyWindow', 'vbext_wt_Find',
           'vbext_wt_Watch', 'vbext_wt_Locals',
           '_dispVBProjectsEvents', 'vbextFileTypeForm',
           'vbextFileTypeGroupProject', '_VBComponents',
           '_VBProjectsEvents', 'vbext_pp_locked', 'AddIn',
           'vbext_vm_Break', 'vbext_CodePaneview', 'vbextFileTypeExe',
           'vbext_pk_Set', '_AddIns', 'VBComponents',
           'vbext_ct_ActiveXDesigner', '_VBComponent',
           'vbext_ProjectProtection', 'vbext_ProcKind',
           'ReferencesEvents', 'vbextFileTypeFrx', 'ProjectTemplate',
           'vbext_wt_FindReplace', '_dispVBComponentsEvents',
           '_ReferencesEvents', 'vbext_pk_Let', 'vbextFileTypeModule',
           'vbext_ct_StdModule', 'VBProject', 'Windows', 'Addins',
           '_VBComponents_Old', 'VBComponent', 'CommandBarEvents',
           'VBE', 'vbext_wt_Designer', 'vbext_ComponentType',
           'vbext_rk_Project', '_VBComponent_Old', 'vbextFileTypeRes',
           'vbext_vm_Design', 'vbext_wt_Immediate', '_Windows',
           '_VBProject', 'vbext_wt_ToolWindow',
           'vbextFileTypeProject', 'vbext_RefKind', '_Properties',
           '_dispReferences_Events', 'vbext_rk_TypeLib',
           '_CodeModule', 'vbext_pt_StandAlone',
           '_dispCommandBarControlEvents', 'vbext_ProjectType',
           '_VBComponentsEvents', 'CodeModule', 'vbext_wt_CodeWindow',
           '_Component', 'Events', 'vbext_pt_HostProject',
           '_VBProject_Old', 'vbext_cv_FullModuleView',
           'vbext_VBAMode', 'vbext_vm_Run', '_VBProjects', 'Property',
           'VBProjects', '_LinkedWindows', 'vbextFileTypeDocObject',
           'vbext_ct_ClassModule', '_CommandBarControlEvents',
           'Properties', '_CodePane', 'vbext_wt_MainWindow',
           '_ProjectTemplate', 'vbext_pk_Proc', 'LinkedWindows',
           'Window', 'vbextFileTypeBinary', 'vbext_wt_Browser',
           'vbext_WindowState', 'CodePanes', 'vbextFileTypeDesigners',
           '_CodePanes', 'vbext_WindowType',
           'vbextFileTypePropertyPage', 'Reference', 'CodePane',
           'vbext_cv_ProcedureView', 'vbext_wt_Toolbox',
           'vbextFileTypeClass', 'vbext_ws_Minimize',
           'vbext_ws_Normal', '_Windows_old', '_References',
           'Component', '_dispReferencesEvents', '_VBProjects_Old',
           'vbext_ct_MSForm', 'Application', 'vbextFileTypes',
           'vbext_wt_LinkedWindowFrame', 'vbextFileTypeUserControl']
from comtypes import _check_version; _check_version('1.1.11', 1651817323.6611912)
